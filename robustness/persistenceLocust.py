...
class UserTaskSet(TaskSet):
    ...
    def on_start(self):
        ...
        if self.once != 1:
            ...
            to_send = {"action": "register", "identifier": self.guest_name, "username": self.username, "pwd": "123"}
            ...
            to_send = {"action": "login", "identifier": self.guest_name, "username": self.username, "pwd": "123"}
            msg = json.dumps(to_send)
            start_time = time.time()
            self.ws.send(msg)
            self.ws.recv()
            ...
            to_send = {"action": "addProductsToStore",
                       ...
                       "productDTO": json.dumps({"name": "Botnim",
                                                 "storeID": store_id,
                                                 "price": 100,
                                                 "categories": ["Botnim"],
                                                 "keywords": ["Botnim"]

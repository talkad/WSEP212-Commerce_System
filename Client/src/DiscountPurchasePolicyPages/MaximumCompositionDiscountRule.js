...
class MaximumCompositionDiscountRule extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            username: '1',
            storeId: '2',
            type: 'MaximumCompositionDiscountRule',
            policyRules: '',
        };
    }
    ...
    render() {
        return (
            <form>
                <h1>Maximum Composition Discount Rule Page</h1>
...
export default MaximumCompositionDiscountRule;